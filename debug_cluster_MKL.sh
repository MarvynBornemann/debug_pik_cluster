...
perf record -o perf-debug_cluster_MKL-$SLURM_JOBID.data julia --threads=$SLURM_CPUS_PER_TASK /home/borneman/Masterarbeit/debug_pik_cluster/debug_cluster.jl MKL